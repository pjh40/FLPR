...
bool real_literal_constant() {
  ...
  TEST_INT(tr_it->main_text_line(), 0);
  TEST_INT(tr_it->main_text_eline(), 0);
  TEST_INT(tr_it->main_text_col(), 2);
  TEST_INT(tr_it->main_text_ecol(), 5);
  ++tr_it;
  TEST_TAG(tr_it->token, SG_EXPONENT_LETTER);
  TEST_STR("e", tr_it->text());
  TEST_INT(tr_it->main_text_line(), 0);
  TEST_INT(tr_it->main_text_eline(), 0);
  TEST_INT(tr_it->main_text_col(), 5);
  TEST_INT(tr_it->main_text_ecol(), 6);
  ++tr_it;
  TEST_TAG(tr_it->token, SG_EXPONENT);
  TEST_STR("-50", tr_it->text());
  TEST_INT(tr_it->main_text_line(), 0);
  TEST_INT(tr_it->main_text_eline(), 0);
  TEST_INT(tr_it->main_text_col(), 6);
  TEST_INT(tr_it->main_text_ecol(), 9);
  ++tr_it;
  TEST_TAG(tr_it->token, TK_UNDERSCORE);
  TEST_STR("_", tr_it->text());
  TEST_INT(tr_it->main_text_line(), 0);
  TEST_INT(tr_it->main_text_eline(), 0);
  TEST_INT(tr_it->main_text_col(), 9);
  TEST_INT(tr_it->main_text_ecol(), 10);
  ++tr_it;
  TEST_TAG(tr_it->token, SG_KIND_PARAM);
  TEST_STR("d_p", tr_it->text());
  TEST_INT(tr_it->main_text_line(), 0);
  TEST_INT(tr_it->main_text_eline(), 0);
  TEST_INT(tr_it->main_text_col(), 10);
  TEST_INT(tr_it->main_text_ecol(), 13);
